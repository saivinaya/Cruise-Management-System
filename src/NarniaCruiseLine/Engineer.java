 ...
 * it has overridden methods getSailorSalary() to give 80000 as the Engineer salary and
 * getSailorOccupation() to give Engineer as output.
 * @author VinayaSaiD
 */
public class Engineer extends Sailor{
    ...
    public Engineer()
    {   setSailorSalary(80000);
    }
    
    public Engineer(long number, String name, Date date , String nationality, boolean isSuper, double money)
    {
        ...
        setSailorOccupation("Engineer");
        supervisor = "-";
    }
    public Engineer(long number, String name, Date date, String nationality, boolean isSuper, double money, String supervisorPerson)
    {
